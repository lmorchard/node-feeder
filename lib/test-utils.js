...
module.exports.createTestServer = function createTestServer (port) {
    ...
    app.configure(function () {
        ...
        // gzip-fixtures - serve up gzip'd fixtures
        app.use('/gzip-fixtures', gzippo.staticGzip(d('fixtures'), {
            contentTypeMatch: /xml|text|javascript|json/
        }));
...
module.exports.trackedResourcesTopic = 
        function trackedResourcesTopic(url_prefix, with_disabled) {
    return function () {
        var $this = this;
